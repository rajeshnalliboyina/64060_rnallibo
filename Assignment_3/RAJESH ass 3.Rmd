...
```{r}
accident_data <- read.csv("C:\\Users\\rajes\\OneDrive\\Desktop\\Business analytics sem1\\FML\\accidentsFull.csv")
head(accident_data)
```
...
X1= df1[3,1]/df2[1,1] #if TRAF_CON_R=0, WEATHER_R=1
X2= df1[3,2]/df2[1,2] #if TRAF_CON_R=1, WEATHER_R=1
X3= df1[3,3]/df2[1,3] #if TRAF_CON_R=2, WEATHER_R=1
X4= df1[4,1]/df2[2,1] #if TRAF_CON_R=0, WEATHER_R=2
X5= df1[4,2]/df2[2,2] #if TRAF_CON_R=1, WEATHER_R=2
X6= df1[4,3]/df2[2,3] #if TRAF_CON_R=2, WEATHER_R=2

#if INJURY  is no

Y1= df1[1,1]/df2[1.1] #if TRAD_CON_R=0, WEATHER_R=1
Y2= df1[1,2]/df2[1,2] #if TRAF_CON_R=1, WEATHER_R=1
Y3= df1[1,3]/df2[1,3] #if TRAF_CON_R=2, WEATHER_R=1
Y4= df1[2,1]/df2[2,1] #if TRAF_CON_R=0, WEATHER_R=2
Y5= df1[2,2]/df2[2,2] #if TRAF_CON_R=1, WEATHER_R=2
Y6= df1[2,3]/df2[2,3] #if TRAF_CON_R=2, WEATHER_R=2

print(c(X1,X2,X3,X4,X5,X6))
...
n1<- train(INJURY ~ TRAF_CON_R + WEATHER_R, 
      data = accidents24, method= "nb")

pred.n1 <- predict(n1, newdata = accidents24[,c("INJURY", "WEATHER_R", "TRAF_CON_R")])
pred1.n1 <- predict(n1, newdata = accidents24[,c("INJURY", "WEATHER_R", "TRAF_CON_R")], type = "raw")
pred.n1
pred1.n1
